...
Each ACP transport connection is represented by four HTTP endpoints:
...
- HTTP only; HTTPS and auth are expected to be handled by surrounding infrastructure for now
